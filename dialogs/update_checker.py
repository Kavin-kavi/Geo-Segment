...
class UpdateCheckerDialog(QDialog):
    ...
    def __init__(self, plugin_dir, parent=None):
        ...
        self.setWindowTitle("Geo Segment Plugin Update")
    ...
    def _setup_ui(self):
        ...
        # Header
        header_label = QLabel("Geo Segment Plugin Update Checker")
        header_font = QFont()
    ...
    def _on_download_finished(self, install_path):
        ...
        QMessageBox.information(
            self,
            "Update Complete",
            f"Geo Segment Plugin has been updated to version {self.latest_version}.\n\n"
