"""
SamGeo Dock Widget for Geo Segment Plugin
...
class SamGeoDockWidget(QDockWidget):
    ...
    def _create_model_tab(self):
        ...
        self.unload_model_btn.setToolTip("Unload the currently loaded SAM Geo model from memory")
        self.unload_model_btn.clicked.connect(self.unload_model)
        model_btn_row.addWidget(self.unload_model_btn)
        backend_layout.addLayout(model_btn_row)
    ...
    def _create_text_tab(self):
        ...
        unload_text_btn = QPushButton("Unload Model")
        unload_text_btn.setToolTip("Unload the currently loaded SAM Geo model from memory")
        unload_text_btn.clicked.connect(self.unload_model)
        text_layout.addWidget(unload_text_btn)
    ...
    def _create_interactive_tab(self):
        ...
        unload_interactive_btn = QPushButton("Unload Model")
        unload_interactive_btn.setToolTip("Unload the currently loaded SAM Geo model from memory")
        unload_interactive_btn.clicked.connect(self.unload_model)
        interactive_layout.addWidget(unload_interactive_btn)
    ...
    def _create_batch_tab(self):
        ...
        unload_batch_btn = QPushButton("Unload Model")
        unload_batch_btn.setToolTip("Unload the currently loaded SAM Geo model from memory")
        unload_batch_btn.clicked.connect(self.unload_model)
        batch_layout.addWidget(unload_batch_btn)
    ...
    def _create_output_tab(self):
        ...
        unload_output_btn = QPushButton("Unload Model")
        unload_output_btn.setToolTip("Unload the currently loaded SAM Geo model from memory")
        unload_output_btn.clicked.connect(self.unload_model)
        output_layout.addWidget(unload_output_btn)
    ...
    def unload_model(self):
        """Unload the currently loaded SAM Geo model from memory."""
        if self.sam is None:
            QMessageBox.information(self, "Unload Model", "No model is currently loaded.")
            return
        self.sam = None
        self.current_image_path = None
        ...
        self.image_status.setStyleSheet("color: gray;")
        self.log_message("SAM Geo model unloaded from memory")
    ...
    def log_message(self, message, level=Qgis.Info):
        ...
        QgsMessageLog.logMessage(message, "Geo Segment - SamGeo", level)
