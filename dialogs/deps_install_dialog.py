"""Dependency installation dock widget for Geo Segment QGIS Plugin.
...
class DepsInstallDockWidget(QDockWidget):
    ...
    def __init__(self, parent=None):
        ...
        """
        super().__init__("Geo Segment - Setup", parent)
        self.setObjectName("GeoSegmentDepsInstallDock")
        ...
        welcome_text = QLabel(
            "Geo Segment needs to install AI dependencies before you can use it.\n\n"
        ...
        help_label = QLabel(
            ...
            '<a href="https://github.com/opengeos/geo-segment/">documentation</a> '
            "or report a bug on "
            '<a href="https://github.com/opengeos/geo-segment/issues">GitHub</a>.'
            "</small>"
        )
